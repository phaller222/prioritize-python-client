...
from prioritize_client.api_response import ApiResponse, T as ApiResponseT
import prioritize_client.models
from prioritize_client import rest
from prioritize_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(prioritize_client.models, klass)
