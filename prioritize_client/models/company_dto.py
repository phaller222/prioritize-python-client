...
class CompanyDTO(BaseModel):
    ...
    main_address: Optional[AddressDTO] = Field(default=None, alias="mainAddress")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "url", "vatNumber", "taxId", "mainAddress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taxId": obj.get("taxId"),
            "mainAddress": AddressDTO.from_dict(obj["mainAddress"]) if obj.get("mainAddress") is not None else None
        })
        return _obj
