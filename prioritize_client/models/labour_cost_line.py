...
class LabourCostLine(BaseModel):
    """
    LabourCostLine
    """ # noqa: E501
    qualification_level: Optional[StrictStr] = Field(default=None, alias="qualificationLevel")
    total_seconds: Optional[StrictInt] = Field(default=None, alias="totalSeconds")
    sessions: Optional[StrictInt] = None
    billed_units: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="billedUnits")
    unit: Optional[StrictStr] = None
    rate: Optional[Union[StrictFloat, StrictInt]] = None
    currency: Optional[StrictStr] = None
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    running: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["qualificationLevel", "totalSeconds", "sessions", "billedUnits", "unit", "rate", "currency", "amount", "running"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "qualificationLevel": obj.get("qualificationLevel"),
            "totalSeconds": obj.get("totalSeconds"),
            "sessions": obj.get("sessions"),
            "billedUnits": obj.get("billedUnits"),
            "unit": obj.get("unit"),
            "rate": obj.get("rate"),
