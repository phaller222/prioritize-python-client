...
class EquipmentSession(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "resourceId", "resourceName", "from", "until", "seconds", "running", "correction"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of correction
        if self.correction:
            _dict['correction'] = self.correction.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "correction": Correction.from_dict(obj["correction"]) if obj.get("correction") is not None else None
        })
        return _obj
