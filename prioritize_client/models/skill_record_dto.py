...
class SkillRecordDTO(BaseModel):
    """
    SkillRecordDTO
    """ # noqa: E501
    id: Optional[StrictInt] = None
    skill_id: Optional[StrictInt] = Field(default=None, alias="skillId")
    skill_name: Optional[StrictStr] = Field(default=None, alias="skillName")
    enthusiasm: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "skillId", "skillName", "enthusiasm"]
