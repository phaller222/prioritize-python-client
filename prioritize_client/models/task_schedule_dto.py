...
class TaskScheduleDTO(BaseModel):
    ...
    next_fire_at: Optional[datetime] = Field(default=None, alias="nextFireAt")
    last_fired_at: Optional[datetime] = Field(default=None, alias="lastFiredAt")
    __properties: ClassVar[List[str]] = ["id", "projectId", "name", "taskName", "taskDescription", "taskPriority", "cronExpression", "zoneId", "enabled", "nextFireAt", "lastFiredAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nextFireAt": obj.get("nextFireAt"),
            "lastFiredAt": obj.get("lastFiredAt")
        })
        return _obj
