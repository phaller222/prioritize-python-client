...
class EquipmentCostLine(BaseModel):
    """
    EquipmentCostLine
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["resourceId", "resourceName", "totalSeconds", "bookings", "billedUnits", "unit", "rate", "currency", "amount", "running"]
