...
class TelemetryRuleDTO(BaseModel):
    """
    TelemetryRuleDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "resourceId", "datapoint", "operator", "threshold", "thresholdHigh", "hysteresis", "severity", "enabled", "state", "lastTransitionAt"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['OK', 'ALARM']):
            raise ValueError("must be one of enum values ('OK', 'ALARM')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "lastTransitionAt": obj.get("lastTransitionAt")
        })
        return _obj
