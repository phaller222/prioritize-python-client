...
class TaskCostReport(BaseModel):
    ...
    equipment: Optional[EquipmentCostReport] = None
    labour: Optional[LabourCostReport] = None
    totals: Optional[List[CurrencyTotal]] = None
    rates_missing: Optional[StrictBool] = Field(default=None, alias="ratesMissing")
    __properties: ClassVar[List[str]] = ["taskId", "equipment", "labour", "totals", "ratesMissing"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of labour
        if self.labour:
            _dict['labour'] = self.labour.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "equipment": EquipmentCostReport.from_dict(obj["equipment"]) if obj.get("equipment") is not None else None,
            "labour": LabourCostReport.from_dict(obj["labour"]) if obj.get("labour") is not None else None,
