...
class ProcessInstanceDTO(BaseModel):
    """
    ProcessInstanceDTO
    """ # noqa: E501
    ...
    business_key: Optional[StrictStr] = Field(default=None, alias="businessKey")
    ...
    __properties: ClassVar[List[str]] = ["id", "processKey", "definitionId", "businessKey", "projectId", "taskId", "running", "startedAt", "startedBy"]
