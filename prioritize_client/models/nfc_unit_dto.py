...
class NfcUnitDTO(BaseModel):
    ...
    last_scan_time: Optional[datetime] = Field(default=None, alias="lastScanTime")
    resource_id: Optional[StrictInt] = Field(default=None, alias="resourceId")
    bound_task_id: Optional[StrictInt] = Field(default=None, alias="boundTaskId")
    __properties: ClassVar[List[str]] = ["id", "uuid", "name", "description", "type", "payload", "sequenceNumber", "lastScanTime", "resourceId", "boundTaskId"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['COUNTER', 'CHECKPOINT', 'TIMETRACKER', 'EQUIPMENT', 'INFOPOINT', 'OTHER']):
            raise ValueError("must be one of enum values ('COUNTER', 'CHECKPOINT', 'TIMETRACKER', 'EQUIPMENT', 'INFOPOINT', 'OTHER')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "boundTaskId": obj.get("boundTaskId")
        })
        return _obj
