...
class NfcUnitDTO(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['COUNTER', 'CHECKPOINT', 'TIMETRACKER', 'INFOPOINT', 'OTHER']):
            raise ValueError("must be one of enum values ('COUNTER', 'CHECKPOINT', 'TIMETRACKER', 'INFOPOINT', 'OTHER')")
        return value
