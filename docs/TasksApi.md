...
------------- | ------------- | -------------
[**task_add_equipment_session**](TasksApi.md#task_add_equipment_session) | **POST** /api/v1/tasks/{id}/equipment/{resourceId}/sessions | Books an equipment usage by hand that was never clocked
...
[**task_delete_equipment_session**](TasksApi.md#task_delete_equipment_session) | **DELETE** /api/v1/tasks/{id}/equipment/sessions/{sessionId} | Removes a completed equipment booking
...
[**task_get_equipment_cost**](TasksApi.md#task_get_equipment_cost) | **GET** /api/v1/tasks/{id}/equipment/cost | Returns the equipment cost of the task (duration times rate, per currency)
[**task_get_equipment_sessions**](TasksApi.md#task_get_equipment_sessions) | **GET** /api/v1/tasks/{id}/equipment/sessions | Returns the individual equipment bookings of the task
[**task_get_equipment_usage**](TasksApi.md#task_get_equipment_usage) | **GET** /api/v1/tasks/{id}/equipment | Returns the time booked per piece of equipment on the task
[**task_get_labour_cost**](TasksApi.md#task_get_labour_cost) | **GET** /api/v1/tasks/{id}/labour/cost | Returns the labour cost of the task, by qualification level
[**task_get_task**](TasksApi.md#task_get_task) | **GET** /api/v1/tasks/{id} | Get task
[**task_get_task_cost**](TasksApi.md#task_get_task_cost) | **GET** /api/v1/tasks/{id}/cost | Returns the full cost of the task: equipment plus labour, totals per currency
...
[**task_start_equipment_usage**](TasksApi.md#task_start_equipment_usage) | **POST** /api/v1/tasks/{id}/equipment/{resourceId}/start | Clocks a piece of equipment onto the task
[**task_start_tracking**](TasksApi.md#task_start_tracking) | **POST** /api/v1/tasks/{id}/tracking/start | Start tracking
[**task_stop_equipment_usage**](TasksApi.md#task_stop_equipment_usage) | **POST** /api/v1/tasks/{id}/equipment/{resourceId}/stop | Clocks a piece of equipment off the task
[**task_stop_equipment_usage_at**](TasksApi.md#task_stop_equipment_usage_at) | **POST** /api/v1/tasks/{id}/equipment/{resourceId}/stop-at | Clocks a piece of equipment off at an earlier point in time
...
[**task_toggle_equipment_usage**](TasksApi.md#task_toggle_equipment_usage) | **POST** /api/v1/tasks/{id}/equipment/{resourceId}/toggle | Toggles a piece of equipment on the task
...
[**task_update_equipment_session**](TasksApi.md#task_update_equipment_session) | **PUT** /api/v1/tasks/{id}/equipment/sessions/{sessionId} | Corrects the start and end of a completed equipment booking
...
# **task_add_equipment_session**
> EquipmentSession task_add_equipment_session(id, resource_id, equipment_session_request)
...
with prioritize_client.ApiClient(configuration) as api_client:
    ...
    id = 56 # int | 
    resource_id = 56 # int | 
    equipment_session_request = prioritize_client.EquipmentSessionRequest() # EquipmentSessionRequest | 

    try:
        # Books an equipment usage by hand that was never clocked
        api_response = api_instance.task_add_equipment_session(id, resource_id, equipment_session_request)
        print("The response of TasksApi->task_add_equipment_session:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TasksApi->task_add_equipment_session: %s\n" % e)
```
 ...
 **id** | **int**|  | 
 **resource_id** | **int**|  | 
 **equipment_session_request** | [**EquipmentSessionRequest**](EquipmentSessionRequest.md)|  | 

### Return type

[**EquipmentSession**](EquipmentSession.md)
...
# **task_delete_equipment_session**
> task_delete_equipment_session(id, session_id)
...
with prioritize_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Removes a completed equipment booking
        api_instance.task_delete_equipment_session(id, session_id)
    except Exception as e:
        print("Exception when calling TasksApi->task_delete_equipment_session: %s\n" % e)
```
...
# **task_get_equipment_cost**
> EquipmentCostReport task_get_equipment_cost(id)
...
with prioritize_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Returns the equipment cost of the task (duration times rate, per currency)
        api_response = api_instance.task_get_equipment_cost(id)
        print("The response of TasksApi->task_get_equipment_cost:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TasksApi->task_get_equipment_cost: %s\n" % e)
```
...
[**EquipmentCostReport**](EquipmentCostReport.md)
...
# **task_get_equipment_sessions**
> List[EquipmentSession] task_get_equipment_sessions(id)
...
with prioritize_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Returns the individual equipment bookings of the task
        api_response = api_instance.task_get_equipment_sessions(id)
        print("The response of TasksApi->task_get_equipment_sessions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TasksApi->task_get_equipment_sessions: %s\n" % e)
```
...
[**List[EquipmentSession]**](EquipmentSession.md)
...
# **task_get_equipment_usage**
> List[EquipmentUsageSummary] task_get_equipment_usage(id)
...
with prioritize_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Returns the time booked per piece of equipment on the task
        api_response = api_instance.task_get_equipment_usage(id)
        print("The response of TasksApi->task_get_equipment_usage:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TasksApi->task_get_equipment_usage: %s\n" % e)
```
...
[**List[EquipmentUsageSummary]**](EquipmentUsageSummary.md)
...
# **task_get_labour_cost**
> LabourCostReport task_get_labour_cost(id)
...
with prioritize_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Returns the labour cost of the task, by qualification level
        api_response = api_instance.task_get_labour_cost(id)
        print("The response of TasksApi->task_get_labour_cost:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TasksApi->task_get_labour_cost: %s\n" % e)
```
...
[**LabourCostReport**](LabourCostReport.md)
...
# **task_get_task_cost**
> TaskCostReport task_get_task_cost(id)
...
with prioritize_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Returns the full cost of the task: equipment plus labour, totals per currency
        api_response = api_instance.task_get_task_cost(id)
        print("The response of TasksApi->task_get_task_cost:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TasksApi->task_get_task_cost: %s\n" % e)
```
...
[**TaskCostReport**](TaskCostReport.md)
...
# **task_start_equipment_usage**
> TaskDTO task_start_equipment_usage(id, resource_id)
...
with prioritize_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Clocks a piece of equipment onto the task
        api_response = api_instance.task_start_equipment_usage(id, resource_id)
        print("The response of TasksApi->task_start_equipment_usage:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TasksApi->task_start_equipment_usage: %s\n" % e)
```
...
# **task_stop_equipment_usage**
> TaskDTO task_stop_equipment_usage(id, resource_id)
...
with prioritize_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Clocks a piece of equipment off the task
        api_response = api_instance.task_stop_equipment_usage(id, resource_id)
        print("The response of TasksApi->task_stop_equipment_usage:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TasksApi->task_stop_equipment_usage: %s\n" % e)
```
...
# **task_stop_equipment_usage_at**
> TaskDTO task_stop_equipment_usage_at(id, resource_id, equipment_stop_at_request)
...
with prioritize_client.ApiClient(configuration) as api_client:
    ...
    id = 56 # int | 
    resource_id = 56 # int | 
    equipment_stop_at_request = prioritize_client.EquipmentStopAtRequest() # EquipmentStopAtRequest | 

    try:
        # Clocks a piece of equipment off at an earlier point in time
        api_response = api_instance.task_stop_equipment_usage_at(id, resource_id, equipment_stop_at_request)
        print("The response of TasksApi->task_stop_equipment_usage_at:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TasksApi->task_stop_equipment_usage_at: %s\n" % e)
```
 ...
 **id** | **int**|  | 
 **resource_id** | **int**|  | 
 **equipment_stop_at_request** | [**EquipmentStopAtRequest**](EquipmentStopAtRequest.md)|  | 
...
# **task_toggle_equipment_usage**
> TaskDTO task_toggle_equipment_usage(id, resource_id)
...
with prioritize_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Toggles a piece of equipment on the task
        api_response = api_instance.task_toggle_equipment_usage(id, resource_id)
        print("The response of TasksApi->task_toggle_equipment_usage:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TasksApi->task_toggle_equipment_usage: %s\n" % e)
```
...
# **task_update_equipment_session**
> EquipmentSession task_update_equipment_session(id, session_id, equipment_session_request)
...
with prioritize_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Corrects the start and end of a completed equipment booking
        api_response = api_instance.task_update_equipment_session(id, session_id, equipment_session_request)
        print("The response of TasksApi->task_update_equipment_session:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TasksApi->task_update_equipment_session: %s\n" % e)
```
